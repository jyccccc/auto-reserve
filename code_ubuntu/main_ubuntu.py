...
if __name__ == '__main__':
    ...
    keys = ['username','start_date','end_date','password','area','pos','email','key','url']
    values = [username,start_date,end_date,password,area,pos,email,'',url]
    global_vars._init()
